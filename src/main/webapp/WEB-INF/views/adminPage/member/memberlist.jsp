...
<div class="jq-layout rel" data-options="fit:true">
	<div data-options="region:'north',border:false">
		<div id="grid-toolbar" class="clearfix p5" >
			...
			<td>
				<input type="text" id="memberNo" name="memberNo" style="width:100px" placeholder="精确查询"/>
			</td>
	...
	<div data-options="region:'center',border:false">
		<table class="jq-datagrid"  id="member_grid" data-options="{
			...
			<%--	{field:'score',title:'积分余额',width:100},
				{field:'coin',title:'惠耳币',width:100},--%>
			<%--	{field:'battery_type',title:'电池型号',width:100},
				{field:'battery_re_qty',title:'电池余量',width:100},--%>
...
<script type="text/javascript">
    ...
    $("#member_grid").datagrid({
    	url: '${z:u("member/memberlist")}',/* 修改路径 */
        queryParams:{
