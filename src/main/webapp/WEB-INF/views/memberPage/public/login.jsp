...
<body id="login">
	<div class="login-wrap-member">
		<form id="form" action="${__url__}" method="post">
			<table>
				<tr>
					<td>
					<div class="loginTd ico_user">
					  <input id="memberNo" type="text" name="memberNo" value="" />
		  ...
		  /*  	if ($loginCaptcha.val() == "") {
		    ...
		    success:function(data) {
				if(data.status==1){
					...
					$("#msg").removeClass("error").addClass("correct").html(data.info);
					window.location.href = "${z:u('/memop/member_index')}";
				}else{
